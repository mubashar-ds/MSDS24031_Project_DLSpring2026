...
INPUT_ROOT = '../datasets/celebv2_frames'
OUTPUT_ROOT = '../datasets/celebv2_cropped_faces'
...
def process_all():
    ...
    failed_file = os.path.join(OUTPUT_ROOT, 'failed_faces.txt')
